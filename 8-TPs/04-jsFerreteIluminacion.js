...
function CalcularPrecio () 
{
     ...
     lamparasIngresadas = parseInt(precioFinal);
     ...
     nombreMarca = Marca.value;
        ...
        {
            if(lamparasIngresadas==5 && marca=="ArgentinaLuz")
            {
            ...
            else
            {
                ...
                {
                    if(lamparasIngresadas==4 && marca=="ArgentinaLuz" || marca=="FelipeLamparas")
                    {
